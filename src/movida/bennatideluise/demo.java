...
public class demo extends MovidaCore{
	...
	public static void main(String[] args) {
		...
		System.out.println("searchMoviesInYear() => " + core.searchMoviesInYear(2012)[0].getTitle());
		System.out.println("searchMoviesDirectedBy() => " + core.searchMoviesDirectedBy("Martin Scorsese")[0].getTitle());
		System.out.println("searchMoviesStarredBy() => " + core.searchMoviesStarredBy("Robert De Niro")[0].getTitle() + " "
				+ core.searchMoviesStarredBy("Robert De Niro")[1].getTitle());
